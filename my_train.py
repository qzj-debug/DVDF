...
if __name__ == "__main__":
    ...
    parser.add_argument("--policy", default="IGDF", help='policy to use')
    parser.add_argument("--env", default="halfcheetah-kinematic-footjnt") # support 
    ...
    parser.add_argument('--shift_level', default="hard", help='the scale of the dynamics shift. Note that this value varies on different settings')
    ...
    outdir = args.dir + '/' + args.policy + '/' + args.env + '-' + str(args.shift_level) + '/' + args.srctype  + '/' + str(args.seed)
