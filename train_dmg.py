...
if __name__ == "__main__":
    ...
    parser.add_argument('--dmglam', default=0.25, type=float)
    parser.add_argument('--dmgnu', default=0.5, type=float)
    ...
    from algo.offline.dmg import DMG
    ...
    for t in range(int(config['max_step'])):
        policy.train_offline(config['batch_size'], writer=None)
